...
if (!defined("BAIDU_AUTOLOADER_PATH"))
{
    define("BAIDU_AUTOLOADER_PATH", dirname(__FILE__));
}
//echo BAIDU_AUTOLOADER_PATH;exit;
require_once (BAIDU_AUTOLOADER_PATH.'\lib\AipBase.php');
