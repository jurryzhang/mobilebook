...
$jieqiPayset['alipay']['payreturn']      ='http://m.kyread.com/User/aliPayReturn.html';  //接收返回的地址 (www.domain.com 是指你的网址)

//这个参数不设置的话，用户可以购买任意值的虚拟货币，按照一元钱100币折算。如果设置了这个参数，则购买金额只能按照里面的设置，对应的也金钱按对应关系折算，如 '1000'=>'10' 是指 1000虚拟币需要10元
$jieqiPayset['alipay']['paylimit']       = array('50000' => '300', '15000' => '100', '7000' => '50', '4000' => '30', '2000'=>'20');
...
$jieqiPayset['alipay']['show_url']       = 'http://m.kyread.com';  //商品相关网站公司
$jieqiPayset['alipay']['seller_email']   = '2308810010@qq.com';  //卖家邮箱，必填
$jieqiPayset['alipay']['sign_type']      = 'MD5';  //签名方式

$jieqiPayset['alipay']['notify_url']     = 'http://m.kyread.com/User/aliPayReturn.php'; //异步返回信息
