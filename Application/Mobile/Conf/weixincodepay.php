...
$jieqiPayset['weixinpay']['appid']       = 'wx709cadf9a947be47'; //公众账号

$jieqiPayset['weixinpay']['mch_id']      = '1482252142'; //微信支付分配的商户号
...
$jieqiPayset['weixinpay']['body']           = '郑州心动文化传媒有限公司'; //商品描述
...
$jieqiPayset['weixinpay']['paylimit']       = $GLOBALS['payLimit'];
