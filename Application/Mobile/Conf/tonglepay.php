...
$tonglepay['merURL'] = 'http://wap.kyread.com/User/tongleReturn.html'; //通知地址
$tonglepay['backURL'] = 'http://wap.kyread.com/User/index.html'; //支付成功跳转地址

//这个参数不设置的话，用户可以购买任意值的虚拟货币，按照一元钱100币折算。如果设置了这个参数，则购买金额只能按照里面的设置，对应的也金钱按对应关系折算，如 '1000'=>'10' 是指 1000虚拟币需要10元
$tonglepay['paylimit']  = $GLOBALS['payLimit'];
