...
<div class="liwu" style="text-align: center;margin-top: -30px;">
    ...
    <div class="cuigeng" style="display: inline-block;font-size: 13px;vertical-align: middle">
        ...
        <ul style="display: inline-block;line-height: 16px;vertical-align: middle">
            <li>催更</li>
            <li style="color: #909090"><?php echo ($userAction['urgeEgold']); ?></li>
        </ul>
    </div>
    <div class="dashang" style="display: inline-block;font-size: 13px;vertical-align: middle;">
        <img style="width:30%;" src="/Template/mobile/default/Static/images/liwu/dashang.png">
        <ul style="display: inline-block;line-height: 16px;vertical-align: middle;">
            <li>打赏</li>
            <li style="color: #909090"><?php echo ($userAction['giftsCount']); ?></li>
        </ul>
    </div>
    <div class="pinglun" style="display: inline-block;width: 27%;font-size: 13px;vertical-align: middle;">
        ...
        <ul style="display: inline-block;line-height: 16px;vertical-align: middle;">
            <li>评论</li>
            <li style="color: #909090"><?php echo ($userAction['commentCount']); ?></li>
        </ul>
    </div>
</div>
    ...
    <div class="want_dashang_bottom">
        ...
        <div class="want_egold">
            ...
            <a href="javascript:void(0);" class="zengsong"
               data-uid="<?php echo ($userinfo["uid"]); ?>" data-articleid="<?php echo ($chapter["articleid"]); ?>" data-chapterid="<?php echo ($chapter["chapterid"]); ?>" date-egold="<?php echo ($userinfo["egold"]); ?>">
                赠送
            </a>
        </div>
    </div>
...
<script>
	...
	var useregold=<?php echo ($userinfo['egold']); ?>;
    ...
    $('.pinglun').click(function(){
        ...
        $(location).attr('href', "/index.php/Gifts/comment/articleid/<?php echo ($chapter['articleid']); ?>/chapterid/<?php echo ($chapter['chapterid']); ?>");
    });
</script>
        </div>
        ...
        <script type="text/javascript">
            $(function() {
                ...
                $("[data-act=read_mode]").live('click', function(event) {
                    ...
                    var _color={"bodybg":"#C1B094","bodybgn":"#1f1c1d","conn":"#353434","conan":"#ffffff","con":"#ffffff","cona":"#0068b7","daycolor":"#999","nightcolor":"#333"};
                    var _read_str="";
